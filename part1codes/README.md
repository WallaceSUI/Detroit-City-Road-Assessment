Test data from Detroit-City real-world dataset

1: Use img-preprocessing-view.py to transform the raw images into single view's images (you should change the path inside it).
you can see some examples from data file

2: Use img-preprocessing-mask.py to add masks into the images (you should change the path inside it).
you can see some examples from data file

3: use whole-workflow.py to output all detection results (you should change the path inside it).
you can see some examples from data file
...
![figure1](https://github.com/WallaceSUI/Detroit-City-Road-Assessment/blob/main/part1codes/reportdata/fig1.png){:height="33%" width="33%"}
...
<center class="half">
<img src="codes/part1codes/reportdata/fig4.png" width = "33%" />
</center>
...
<center class="half">
<img src="codes/part1codes/reportdata/fig5.png" width = "33%" /><img src="codes/part1codes/reportdata/fig6.png" width = "33%" />
</center>
...
<center class="half">
<img src="codes/part1codes/reportdata/fig7.png" width = "33%" /><img src="codes/part1codes/reportdata/fig8.png" width = "33%" /><img src="codes/part1codes/reportdata/fig9.png" width = "33%" />
</center>
