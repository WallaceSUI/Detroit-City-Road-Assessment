...
PATH_TO_LABELS = 'trainedModels/crackLabelMap.pbtxt'
...
'''
import glob
TEST_IMAGE_PATHS = glob.glob('/Users/wallace/Desktop/2020Fall/capstone/report-data/whole250data/*')     ##change the path for testing datasets
'''
TEST_IMAGE_PATHS = ['data/images/0.jpg',
                    'data/images/1.jpg',
                    'data/images/2.jpg',
                    'data/images/3.jpg',
                    'data/images/4.jpg',
